...
//JCP>       case Types.TIMESTAMP_WITH_TIMEZONE:
    ...
    public void setJSONObject(int parameterIndex, JSONObject x) throws SQLException {
        checkClosed();
        setJSONObject(parameterIndex, x, Oid.JSON);
    }

    protected void setJSONObject(int parameterIndex, JSONObject x, int oid) throws SQLException {
        ...
        if (x == null) {
            ...
            bindJSONObject(parameterIndex, x, oid);
        }
    }
     ...
     */
    private void bindJSONObject(int paramIndex, JSONObject s, int oid) throws SQLException {
        if (adjustIndex) {
            paramIndex--;
        }
        preparedParameters.setStringParameter(paramIndex, s.toString(), oid);
    }
...
//JCP>       setTimestamp(parameterIndex, (OffsetDateTime) x);
            ...
            setJSONObject(parameterIndex, (JSONObject) x);
        } else {
            // Can't infer a type.
